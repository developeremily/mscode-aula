...
<head>
    ...
    <link rel="stylesheet" href="soma.php">
    <title>Tabuada de Subtração</title>
</head>
<body>
    ...
    <form method="get" action="">
        ...
        <?php
        if ($numero !== null): ?>
        <h2>Tabuada de subtração do número <?= $numero ?></h2>
    ...
    <a href="soma.php">Ir para a página de soma</a>
